...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath()%>/resources/themeckeditor/content.css">
    ...
    <div style="margin-top: 100px;">
        <section class="register-photo">
            <div class="form-container">
                <form action="<%= request.getContextPath()%>/IntelligenceArtificielle/TraitAjout" method="post" enctype="multipart/form-data">
                    <h2 class="text-center">Ajout Contenu</h2>
                    <div class="mb-3"><input class="form-control" type="titre" name="titre" placeholder="titre"></div>
                    <div class="mb-3"><input class="form-control" type="date" name="daty"></div>
                    <div class="mb-3"><textarea class="ckeditor form-control" id="contenu" name="contenu" cols="50" rows="5"></textarea></textarea></div>
                    <div class="mb-3"><input class="form-control" type="file" name="sary"></div>
                    <div class="mb-3"><button class="btn btn-primary d-block w-100" type="submit" style="background: rgb(35,33,33);">AJOUTER</button></div>
                </form>
