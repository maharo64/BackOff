...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath()%>/resources/theme/css/Lista-Productos-Canito.css">
        <% 
           List<Contenu> list = (List<Contenu>) request.getAttribute("contenunonvalide");
    %>
</head>
...
<body id="page-top" data-bs-spy="scroll" data-bs-target="#mainNav" data-bs-offset="54">
    ...
    <div style="margin-top: 200px;">
        <h1 style="color: black; margin-left: 500px; margin-top: -50px">Liste Contenu Non Valide</h1>
        <div class="container">
            <div class="row">
